...
INSERT INTO dbo.Agencia (NumeroAgencia, NomeAgencia, Cidade, UF)
VALUES
...
INSERT INTO dbo.Conta (ClienteID, AgenciaID, NumeroConta, TipoConta, Saldo, StatusConta)
VALUES
(1, 1, '10001-0', 'CORRENTE', 2500.00, 'ATIVA'),
(2, 1, '10002-8', 'POUPANCA', 870.00, 'ATIVA'),
(3, 2, '10003-6', 'CORRENTE', 6400.00, 'ATIVA'),
(4, 3, '10004-4', 'SALARIO', 1320.50, 'ATIVA'),
(5, 2, '10005-2', 'CORRENTE', 9800.75, 'ATIVA');
GO

INSERT INTO dbo.Cartao (ClienteID, ContaID, NumeroCartao, TipoCartao, Limite, DataValidade, StatusCartao)
VALUES
...
INSERT INTO dbo.Transacao (ContaID, TipoTransacao, Valor, DataTransacao, Descricao)
VALUES
...
INSERT INTO dbo.Emprestimo (ClienteID, ValorSolicitado, TaxaJuros, QuantidadeParcelas, StatusEmprestimo)
VALUES
